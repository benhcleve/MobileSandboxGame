...
public class NPCEquipmentManager : MonoBehaviour
{
    ...
    public GameObject facialHairWorn;
    ...
    {
        StartCoroutine(Wear(2004, "Head", null, new Color32(50, 40, 30, 0)));
        yield return new WaitForSeconds(0.01f);
        StartCoroutine(Wear(2005, "Facial Hair", null, new Color32(50, 40, 30, 0)));
        yield return new WaitForSeconds(0.01f);
        StartCoroutine(Wear(2002, "Legs", null, new Color32(255, 255, 255, 0)));
        yield return new WaitForSeconds(0.01f);
        StartCoroutine(Wear(2006, "Chest", null, new Color32(110, 20, 20, 0)));
    }
    ...
    public void RemoveWorn(string apparelType)
    {
        switch (apparelType)
        {
            case "Head":
                ...
                break;
            case "Facial Hair":
                if (facialHairWorn == null)
                    return;
                Destroy(facialHairWorn);
                facialHairWorn = null;
                break;
            case "Chest":
                if (chestWorn == null)
