    ...
    SubShader {
        ...
        Pass {
			...
			float4 frag(VertexOutput i) : COLOR 
			{
					...
					float node_6587 = 0.0;
					half3 RTD_OL_LAOC_OO = lerp( lerp(_OutlineColor.rgb,_OutlineColor.rgb * _MainTex_var, _MixMainTexToOutline) , lerp(float3(node_6587,node_6587,node_6587), lerp(_OutlineColor.rgb,_OutlineColor.rgb * _MainTex_var, _MixMainTexToOutline) ,lightColor.rgb), _LightAffectOutlineColor ); 
					//
